...
def start_flask_server():
    ...
    try:
        ...
        print("🚀 Starting Flask server on port 25595...")
        print("🌐 Access your application at: https://bet-tracking-ai.com:25595")
        print("📊 Health check: https://bet-tracking-ai.com:25595/health")
        print("📄 Subscription page: https://bet-tracking-ai.com:25595/subscriptions")
